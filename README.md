...
* **Builder Repository:** All build scripts, configuration templates, and GitHub Actions workflows in this repository are released into the public domain under [The Unlicense](LICENSE). You may use, modify, or redistribute them without restriction or attribution.
* **Upstream Code & Compiled Artifacts:** This tool fetches and packages upstream PokeRogue source code. The output binaries, assets, and packaged client releases generated by this builder contain PokeRogue source code, which remains subject to its original license (**AGPL-3.0**). The public domain status of this builder tool does **not** grant rights to or alter the licensing of the packaged PokeRogue application itself.
